...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $productos = [
            ...
            // --- ACCESORIOS (NUEVA COLECCIÓN DEL ALUMNO) ---
            [ 'nombre' => 'Sombrero Fedora Camel', 'desc' => 'Elegante sombrero de ala ancha en tono camel. Confeccionado en fieltro de lana premium, es el accesorio definitivo para aportar un toque sofisticado a cualquier look de temporada.', 'precio' => 8500, 'stock' => 5, 'material' => 'Fieltro de Lana', 'destacado' => true, 'cat' => 'accesorios', 'imagen' => 'accesorio-0.png' ],
            [ 'nombre' => 'Sombrero Fedora Negro', 'desc' => 'Clásico sombrero fedora en color negro profundo. Su diseño atemporal de ala ancha y copa estructurada lo convierte en una pieza de elegancia atemporal.', 'precio' => 8500, 'stock' => 10, 'material' => 'Fieltro de Lana', 'destacado' => false, 'cat' => 'accesorios', 'imagen' => 'accesorio-1.png' ],
            [ 'nombre' => 'Sombrero Canotier Rústico', 'desc' => 'Sombrero estilo canotier confeccionado en paja natural trenzada con distintiva cinta negra. Ligero y con personalidad, ideal para protegerte del sol con auténtica estética parisina.', 'precio' => 6500, 'stock' => 8, 'material' => 'Paja Natural', 'destacado' => true, 'cat' => 'accesorios', 'imagen' => 'accesorio-2.png' ],
            [ 'nombre' => 'Sombrero Panamá Clásico', 'desc' => 'Auténtico sombrero panamá de ala media trenzado a mano. Su distintiva cinta negra y color crudo lo hacen el acompañante perfecto para escapadas estivales de lujo.', 'precio' => 12000, 'stock' => 12, 'material' => 'Paja Toquilla', 'destacado' => false, 'cat' => 'accesorios', 'imagen' => 'accesorio-3.png' ],
            [ 'nombre' => 'Sombrero Fedora Gris Ceniza', 'desc' => 'Sombrero fedora de ala corta en tono gris ceniza con cinta en contraste. Confeccionado en lana de alta densidad, ofrece un estilo urbano, contemporáneo y muy versátil.', 'precio' => 7500, 'stock' => 4, 'material' => 'Lana Premium', 'destacado' => true, 'cat' => 'accesorios', 'imagen' => 'accesorio-4.png' ],
            [ 'nombre' => 'Colgante Disco Oro 18k', 'desc' => 'Elegante collar de cadena fina en oro amarillo de 18k, adornado con un delicado colgante circular liso. Un diseño minimalista perfecto para el uso diario o para combinar a capas.', 'precio' => 32000, 'stock' => 7, 'material' => 'Oro Amarillo 18k', 'destacado' => false, 'cat' => 'accesorios', 'imagen' => 'accesorio-5.png' ],
            [ 'nombre' => 'Anillo Promesa Diamante', 'desc' => 'Anillo solitario entrelazado en oro amarillo brillante con un exquisito diamante central de talla brillante. Su diseño fluido simboliza la elegancia sutil y el amor eterno.', 'precio' => 145000, 'stock' => 3, 'material' => 'Oro 18k y Diamante', 'destacado' => true, 'cat' => 'accesorios', 'imagen' => 'accesorio-6.png' ],
            [ 'nombre' => 'Pendientes Aro Chunky', 'desc' => 'Pendientes de aro grueso tubular en oro amarillo de 18 quilates. Un básico rotundo y sofisticado que enmarca el rostro con un destello cálido inconfundible.', 'precio' => 45000, 'stock' => 15, 'material' => 'Oro Amarillo 18k', 'destacado' => false, 'cat' => 'accesorios', 'imagen' => 'accesorio-7.png' ],
            [ 'nombre' => 'Pulsera Cadena Minimalista', 'desc' => 'Pulsera ultrafina de eslabones en oro de 18k con un sutil detalle de esfera central. Delicadeza absoluta para adornar la muñeca con elegancia silenciosa y refinada.', 'precio' => 18000, 'stock' => 12, 'material' => 'Oro Amarillo 18k', 'destacado' => true, 'cat' => 'accesorios', 'imagen' => 'accesorio-8.png' ],
            [ 'nombre' => 'Alianza Banda Platino', 'desc' => 'Alianza de diseño arquitectónico en platino cepillado con un elegante surco central. Representa la joyería contemporánea en su forma más pura, noble y resistente.', 'precio' => 185000, 'stock' => 4, 'material' => 'Platino 950', 'destacado' => false, 'cat' => 'accesorios', 'imagen' => 'accesorio-9.png' ],
        ];
